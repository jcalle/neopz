...
//circle 6
//inner circle
p_c7_1 = newp; Point(p_c7_1) = { dist6 ,   0   , 0 };
p_c7_2 = newp; Point(p_c7_2) = { dist7 ,   0   , 0 };
p_c7_3 = newp; Point(p_c7_3) = { dist7 ,   h   , 0 };
p_c7_4 = newp; Point(p_c7_4) = { dist6 ,   h   , 0 };

//arcs
a_c7_1 = newl; Line(a_c7_1) = {p_c7_1 , p_c7_2};
a_c7_2 = newl; Line(a_c7_2) = {p_c7_2 , p_c7_3};
a_c7_3 = newl; Line(a_c7_3) = {p_c7_3 , p_c7_4};
a_c7_4 = newl; Line(a_c7_4) = {p_c7_4 , p_c7_1};

//surfaces
edges_list_7[] = {a_c7_1,a_c7_2,a_c7_3,a_c7_4};
ll_c7_1 = newll; Line Loop(ll_c7_1) = edges_list_7[];
s_c7_1 = news; Plane Surface(s_c7_1) = {ll_c7_1};
